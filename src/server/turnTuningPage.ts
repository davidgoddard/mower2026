...
const TURN_TUNING_WIDGET_OPTIONS = {
  imuCardId: "imu-card",
...
${getLiveSensorWidgetsHtml(TURN_TUNING_WIDGET_OPTIONS)}
      </aside>
...
${getLiveSensorWidgetsScript()}
    ...
    const WIDGET_IDS = ${getLiveSensorWidgetsWidgetIds(TURN_TUNING_WIDGET_OPTIONS)};
